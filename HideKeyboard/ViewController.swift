...
//  HideKeyBoard
//
//  Created by Tyler Gilmore on 9/27/21.
//  Copyright (c) 2021 Rock Valley College. All rights reserved.
//  Updated 9/2019 CK
...
class ViewController: UIViewController, UIScrollViewDelegate, UITextFieldDelegate  {
    ...
    @IBAction func btnSave(_ sender: UIButton) {
        ...
        if (txtFirst.text=="" || txtLast.text=="" || txtColor.text=="")
        {
